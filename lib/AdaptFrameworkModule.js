...
import { runCliCommand, readFrameworkPluginVersions, migrateExistingCourses, computePluginHash, invalidateCache } from './utils.js'
...
class AdaptFrameworkModule extends AbstractModule {
  ...
  /**
   * Invalidates the prebuilt compilation cache
   */
