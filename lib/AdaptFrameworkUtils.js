...
import { App, readJson, writeJson, toBoolean } from 'adapt-authoring-core'
import bytes from 'bytes'
import fs from 'fs/promises'
/* eslint-disable import/no-named-default */import { default as fsSync } from 'fs'
import path from 'upath'
import semver from 'semver'
import { inferBuildAction, getPluginUpdateStatus, getImportContentCounts } from './utils.js'
...
class AdaptFrameworkUtils {
  ...
  /** @deprecated Use `import { readJson } from 'adapt-authoring-core'` */
  static readJson (filepath) { return readJson(filepath) }

  /** @deprecated Use `import { writeJson } from 'adapt-authoring-core'` */
  static writeJson (filepath, data) { return writeJson(filepath, data) }

  /** @deprecated Use `import { inferBuildAction } from './utils.js'` */
  static inferBuildAction (req) { return inferBuildAction(req) }
  ...
  /** @deprecated Use `import { getPluginUpdateStatus } from './utils.js'` */
  static getPluginUpdateStatus (versions, isLocalInstall, updatePlugins) {
    return getPluginUpdateStatus(versions, isLocalInstall, updatePlugins)
  }

  /** @deprecated Use `import { getImportContentCounts } from './utils.js'` */
  static getImportContentCounts (content) {
    return getImportContentCounts(content)
  }
  ...
  /** @deprecated Use `import { toBoolean } from 'adapt-authoring-core'` */
  static toBoolean (val) { return toBoolean(val) }
